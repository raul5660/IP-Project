<%@ Page Title="" Language="C#" MasterPageFile="~/GameBoard/Site2.Master" AutoEventWireup="true" CodeBehind="Game1.aspx.cs" Inherits="Project1.GameBoard.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h1 class="page-header">Game 1</h1>
    <div class="col-xs-12">
        <div class="col-xs-6">
            ...
            <asp:GridView ID="Game1Challenges" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1"
                ...
                <Fields>
                    ...
                    <asp:TemplateField HeaderText="Flag">
                        <ItemTemplate>
                            ...
                            <asp:Button ID="Button1" runat="server" OnClick="FlagSubmit_Click" Text="Submit" OnDataBinding="FlagSubmit_Click" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Fields>
            </asp:DetailsView>
