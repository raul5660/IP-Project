<%@ Page Title="" Language="C#" MasterPageFile="~/GameBoard/Site2.Master" AutoEventWireup="true" CodeBehind="Game2.aspx.cs" Inherits="Project1.GameBoard.WebForm3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <h1 class="page-header">Game 2</h1>
    <div class="col-xs-12">
        <div class="col-xs-6">
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CTFConnectionString %>"
                SelectCommand="SELECT Challenge.Challenge_ID ,Category.Category_Name, Challenge.Challenge_Name, Challenge.Challenge_Points FROM Game INNER JOIN Category ON Game.Game_ID = Category.Game_ID INNER JOIN Challenge ON Category.Category_ID = Challenge.Category_ID WHERE (Category.Game_ID = 2)"></asp:SqlDataSource>
            <asp:GridView ID="Game2Challenges" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1"
        ...
        <div class="col-xs-6">
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:CTFConnectionString %>"
                ...
                <SelectParameters>
                    <asp:ControlParameter ControlID="Game2Challenges" Name="Challenge_ID" PropertyName="SelectedValue" Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
