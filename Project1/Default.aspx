        ...
        <div class="tab-content">
            ...
            <div id="login">
                ...
                <div class="field-wrap">
                    ...
                    <asp:RequiredFieldValidator ID="RFVuser" runat="server" ErrorMessage="* username required"
                ...
                <asp:Button ID="SignIn" runat="server" CssClass="btn btn-success" Text="Sign in" OnClick="SignIn_Click" ValidationGroup="1" />
            </div>
        </div>
        <!-- tab-content -->
    </div>
